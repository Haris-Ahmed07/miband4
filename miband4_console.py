...
# Define the gyroscope callback function
    def gyroscope_callback(data):
        x, y, z = data
        print(f"Gyroscope data - X: {x}, Y: {y}, Z: {z}")
...
if __name__ == "__main__":
    ...
    realtime_gyroscope_item = FunctionItem("@ Get real-time gyroscope data", lambda: band.start_gyroscope_realtime(gyroscope_callback))
    ...
    menu.append_item(realtime_gyroscope_item)
