...
class UUIDS(object):
    ...
    GYROSCOPE_SERVICE_UUID = "0000XXXX-0000-1000-8000-00805f9b34fb"  # Replace with the correct UUID
    GYROSCOPE_CHARACTERISTIC_UUID = "0000YYYY-0000-1000-8000-00805f9b34fb"  # Replace with the correct UUID
